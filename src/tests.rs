        ...
        connection
            .execute_batch(
                ...
                CREATE TABLE IF NOT EXISTS interface_samples (
                    ...
                    alignment_errors INTEGER NOT NULL DEFAULT 0,
                    frame_too_longs INTEGER NOT NULL DEFAULT 0,
                    internal_mac_receive_errors INTEGER NOT NULL DEFAULT 0,
                    rx_optical_power_dbm REAL,
